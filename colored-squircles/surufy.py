...
# which color to choose from each icon's color palette
palette = 0
...
def generate(icon, output):
    with Image(blob=background) as _background:
        ...
        with Image(filename=icon) as _icon:
            ...
            _background.composite_channel('default_channels', _icon, 'atop', _background.width//2-_icon.width//2, _background.height//2-_icon.height//2)
